local library = {
	...
	colors = {
		...
		background = Color3.fromRGB(1, 4, 15),
		outerBorder = Color3.fromRGB(15, 15, 15),
		innerBorder = Color3.fromRGB(2, 9, 255),
		topGradient = Color3.fromRGB(35, 35, 35),
		bottomGradient = Color3.fromRGB(29, 29, 29),
		sectionBackground = Color3.fromRGB(21, 26, 34),
		section = Color3.fromRGB(23, 10, 246),
		otherElementText = Color3.fromRGB(255, 255, 250),
		elementText = Color3.fromRGB(255, 255, 250),
		elementBorder = Color3.fromRGB(20, 20, 205),
		selectedOption = Color3.fromRGB(4, 3, 230),
		unselectedOption = Color3.fromRGB(6, 3, 182),
		...
		tabText = Color3.fromRGB(255, 255, 250)
	},
	gui_parent = (function()
